...
namespace MillionApi.Infrastructure.Repositories
{
    public sealed class PropertyRepository : IPropertyRepository
    {
        ...
        // public async Task<List<Property>> SearchByNameAsync(string name, CancellationToken ct = default)
        // {
        //     // Filtro con regex para buscar coincidencias parciales en Name
